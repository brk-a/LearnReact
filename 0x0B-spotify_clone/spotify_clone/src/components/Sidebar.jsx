  ...
  return (
    <>
      ...
      <div className="md:flex hidden flex-col w-[240] py-10 px-4 bg-[#191624]">
        <img src={logo} alt="logo" className="w-full h-14 object-contain min-w-[300px] md:min-w-[100px] min-h-[300px] md:min-h-[100px]"/>
        <NavLinks />
      </div>
      ...
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-to-tl from-white/10 to-[#483d8b] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen ? 'left-0' : '-left-full'}`}>
        <img src={logo} alt="logo" className="w-full h-14 object-contain min-w-[300px] md:min-w-[100px] min-h-[300px] md:min-h-[100px] mr-10"/>
