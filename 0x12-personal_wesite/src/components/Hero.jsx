    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          I am a full-stack software developer, data scientist and pentester. Before joining
          the IT world, I was in finance and investing for three years.
          My stack is JS, React.js and Next.js in the FE and Py, Django and JS in the BE. 
        </p>
