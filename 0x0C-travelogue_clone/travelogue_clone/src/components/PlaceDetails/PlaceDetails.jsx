...
'https://www.foodserviceandhospitality.com/wp-content/uploads/2016/09/Restaurant-Placeholder-001.jpg'} title={place.name}/>
      ...
      <CardContent>
        ...
        <Button size='small' color='primary' onClick={() => window.open(place.webite, '_blank')}>
          Website
        </Button>
        </CardActions>
      </CardContent>
