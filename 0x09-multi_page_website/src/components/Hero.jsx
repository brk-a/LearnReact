...
const Hero = () => {
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 md:flex-row flex-col xl:px-0 sm:px16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of experts uses a unique method to identify the credit
          cards that most closely fit your needs. We examine annual per
          centage rates, annual fees
        </p>
